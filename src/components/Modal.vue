...
-->
                    <form class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="space-y-12">
                            <div class="pb-12">
                                <h2 class="text-base font-semibold leading-7 text-gray-900">New Movie</h2>
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-4">
                                        <label for="country"
                                            class="block text-sm font-medium leading-6 text-gray-900">Generes</label>
                                        <div class="mt-2">
                                            <select multiple id="country" name="country" autocomplete="country-name"
